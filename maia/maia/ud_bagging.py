...
class UDBaggingClassifier(InterpretableBaggingClassifier):
    ...
    def _fit(self, X, y, max_samples=None, max_depth=None, sample_weight=None, feature_bias=None):
    ...
    def fit(self, X, y, sample_weight=None, feature_bias=None):
        """Build a UDBagging ensemble of estimators from the training
           set (X, y).
        ...
        self : object
        """
        return self._fit(X, y, self.max_samples, sample_weight=sample_weight, feature_bias=feature_bias)